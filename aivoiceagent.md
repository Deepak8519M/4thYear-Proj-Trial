...
<body class="selection:bg-blue-500/30">
                ...
                <div class="space-y-8 text-center lg:text-left">
                    <div class="space-y-4">
                        <div class="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/10 text-blue-400 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border border-blue-500/20">
                            <i data-lucide="heart-pulse" class="w-3 h-3"></i> Midnight Multispecialty v8.5
                        </div>
                        ...
                        <p class="text-slate-400 text-xl font-medium max-w-sm leading-relaxed">
                            Natural voice dialogue. Professional analysis. Locally stored reports.
                        </p>
                    </div>
                    <div class="flex items-center gap-4 p-5 bg-slate-900/50 rounded-2xl border border-slate-800 shadow-sm max-w-xs mx-auto lg:mx-0">
                        <div class="bg-blue-500/20 p-2.5 rounded-xl text-blue-400">
                            <i data-lucide="save" class="w-5 h-5"></i>
                        </div>
                        <div class="text-left">
                            <p class="text-xs font-black text-slate-200 uppercase tracking-widest">Local Vault</p>
                            <p class="text-[11px] text-slate-500">Auto-saving session data</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                        <div class="space-y-3">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" id="user-name" placeholder="Full Name" class="w-full pl-14 pr-6 py-6 bg-slate-950 border-2 border-slate-800 rounded-3xl focus:border-blue-500 outline-none transition-all text-2xl font-bold text-white">
                            </div>
                        </div>

                        <div class="space-y-4">
                            <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Specialty Department</label>
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 role-grid" id="doctor-selector">
                                <button data-role="GP" class="doctor-card active flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="stethoscope" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">General</span>
                                </button>
                                <button data-role="PEDIATRICIAN" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="baby" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Pediatric</span>
                                </button>
                                <button data-role="DERMATOLOGIST" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="sparkles" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Skin</span>
                                </button>
                                <button data-role="CARDIOLOGIST" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="heart" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Heart</span>
                                </button>
                                <button data-role="NEUROLOGIST" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="brain" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Brain</span>
                                </button>
                                <button data-role="PSYCHIATRIST" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="brain-circuit" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Mental</span>
                                </button>
                                <button data-role="ORTHOPEDIC" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="bone" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Bone</span>
                                </button>
                                <button data-role="GYNECOLOGIST" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="venus" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Women</span>
                                </button>
                                <button data-role="OPHTHALMOLOGIST" class="doctor-card flex flex-col items-center p-5 rounded-3xl border-2 transition-all">
                                    <i data-lucide="eye" class="w-6 h-6 mb-2"></i>
                                    <span class="text-[10px] font-black uppercase tracking-tighter">Eye</span>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <section id="consultation-screen" class="step-hidden max-w-4xl mx-auto h-screen flex flex-col justify-between py-24 fade-in-up">
            <div class="text-center space-y-10">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-blue-500 font-bold uppercase tracking-[0.5em] text-[12px] opacity-80">Full Diagnostic Session</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center justify-center space-y-16 my-10">
                <div id="main-avatar" class="relative z-10 w-72 h-72 rounded-[6rem] flex flex-col items-center justify-center border-[20px] border-slate-900 bg-slate-950 transition-all duration-500 shadow-[0_0_120px_rgba(0,0,0,0.9)] text-slate-700">
                    <div id="avatar-icon-container">
                        <i data-lucide="activity" class="w-20 h-20"></i>
                    </div>
                    <p id="avatar-label" class="text-[11px] font-black mt-8 uppercase tracking-[0.6em] opacity-40">Syncing</p>
                </div>

                <div class="max-w-3xl text-center min-h-[140px] flex items-center justify-center px-12">
                    <p id="transcript-text" class="text-slate-100 text-2xl font-bold leading-relaxed tracking-tight italic drop-shadow-lg">Connecting clinical stream...</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center gap-12 pb-10">
                ...
                <div class="flex items-center gap-3 text-slate-600 text-[11px] font-black uppercase tracking-[0.4em]">
                    <div class="w-2.5 h-2.5 bg-green-500 rounded-full shadow-[0_0_20px_rgba(34,197,94,0.6)]"></div>
                    Professional Neural Analysis Active
                </div>
            </div>
        </section>
        ...
        <section id="report-screen" class="step-hidden max-w-4xl mx-auto p-10 space-y-12 pb-32 fade-in-up">
            <div class="flex flex-col md:flex-row md:items-end justify-between border-b-2 border-slate-800 gap-8 pb-10">
                <div class="space-y-3">
                    ...
                    <p class="text-slate-500 font-bold tracking-[0.2em] text-[11px] uppercase">Official Medical Assessment • Multispecialty</p>
                </div>
                <div class="flex gap-4">
                    ...
                    <button onclick="location.reload()" class="px-12 py-5 bg-blue-600 text-white rounded-2xl font-black hover:bg-blue-700 shadow-xl transition-all uppercase text-xs tracking-widest active:scale-95">
                        New Session
                    </button>
                </div>
            </div>
            ...
            <div class="bg-slate-900 rounded-[3.5rem] shadow-2xl border border-slate-800 overflow-hidden">
                <div class="p-14 bg-slate-950/30 border-b border-slate-800 grid grid-cols-1 md:grid-cols-3 gap-14 text-center md:text-left">
                    ...
                    <div class="space-y-2">
                        <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Session ID</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <section class="bg-slate-950 p-12 rounded-[4rem] border border-slate-800 relative overflow-hidden group">
                            ...
                            <div class="flex items-center gap-5 mb-8 relative z-10">
                                ...
                                <h3 class="text-xs font-black text-blue-400 uppercase tracking-[0.4em]">Clinical Narrative</h3>
                            </div>
                            <p id="report-summary" class="text-slate-300 leading-relaxed font-medium text-xl relative z-10">Summarizing...</p>
                        </section>
                        ...
                        <section class="bg-blue-600/10 p-12 rounded-[4rem] border border-blue-500/30 relative overflow-hidden">
                            ...
                            <p id="report-recommendation" class="text-white font-bold text-2xl leading-tight">Analyzing urgency...</p>
                            <p class="text-blue-400 text-sm mt-4 italic opacity-80">*Saved to local medical history.</p>
                        </section>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const DOCTOR_ROLES = {
            ...
            DERMATOLOGIST: { id: 'DERMATOLOGIST', title: 'Dermatologist', icon: 'sparkles', voice: 'Zephyr', greeting: "Hello. I'm reviewing your skin concerns. Where exactly is the issue located?", prompt: "Clinical Dermatologist. Ask detailed questions about color, texture, itching, and spread. Max 20 words." },
            ...
            PSYCHIATRIST: { id: 'PSYCHIATRIST', title: 'Psychiatrist', icon: 'brain-circuit', voice: 'Kore', greeting: "Hello. How has your emotional state or sleep been lately?", prompt: "Empathetic Psychiatrist. Ask full questions about mood, sleep, and appetite. Max 20 words." },
        ...
        const views = { setup: document.getElementById('setup-screen'), consultation: document.getElementById('consultation-screen'), report: document.getElementById('report-screen') };
        ...
        if (Recognition) {
            ...
            mic.onend = () => { micRunning = false; isListening = false; updateUI(); setTimeout(watchdog, 200); };
            mic.onresult = (e) => { const text = e.results[0][0].transcript; if (text && text.trim().length > 0) handleInput(text); };
            mic.onerror = () => { micRunning = false; isListening = false; updateUI(); };
        }
        ...
        function updateUI() {
            ...
            const icon = document.getElementById('avatar-icon-container'); const sLabel = document.getElementById('status-label');
            if (isListening) {
                ...
                label.textContent = "LISTENING"; icon.innerHTML = `<i data-lucide="mic" class="w-20 h-20"></i>`; sLabel.textContent = "CAPTURING VOICE";
            } else if (isPlaying) {
                ...
                label.textContent = "SPEAKING"; icon.innerHTML = `<i data-lucide="volume-2" class="w-20 h-20"></i>`; sLabel.textContent = "AUDIO CHANNEL ACTIVE";
            } else if (isProcessing) {
                label.textContent = "ROUTING"; icon.innerHTML = `<i data-lucide="loader-2" class="w-20 h-20 animate-spin"></i>`; sLabel.textContent = "PROCESSING ASSESSMENT";
            } else {
                ...
                label.textContent = "STANDBY"; icon.innerHTML = `<i data-lucide="${currentRole.icon}" class="w-20 h-20"></i>`; sLabel.textContent = "LINK STABLE";
            }
            lucide.createIcons();
        }
        ...
        document.getElementById('start-btn').addEventListener('click', async () => {
            ...
            if (!pName) { document.getElementById('error-text').textContent = "PATIENT IDENTITY REQUIRED."; document.getElementById('error-text').classList.remove('hidden'); return; }
        ...
        document.getElementById('end-btn').addEventListener('click', async () => {
            ...
            try {
                const res = await api(`https://generativelanguage.googleapis.com/v1beta/models/${MODEL_CHAT}:generateContent?key=${apiKey}`, { contents: [{ role: 'user', parts: [{ text: `Generate JSON Clinical Report. Required keys: chiefComplaint, summary, reportedSymptoms (array), durationAndSeverity, recommendation (choose one: "Hospital Visit Required", "Video Call Follow-up", or "Home Monitoring"). Data: ${JSON.stringify(transcript)}` }] }], generationConfig: { responseMimeType: "application/json", responseSchema: { type: "OBJECT", properties: { chiefComplaint: { type: "STRING" }, summary: { type: "STRING" }, reportedSymptoms: { type: "ARRAY", items: { type: "STRING" } }, durationAndSeverity: { type: "STRING" }, recommendation: { type: "STRING" } } } } });
                const r = JSON.parse(res.candidates[0].content.parts[0].text);
                lastReport = r;
                // Local Storage save
                localStorage.setItem('midnight_last_session', JSON.stringify({ patient: pName, role: currentRole.title, data: r, date: new Date().toISOString() }));
                
                document.getElementById('report-name').textContent = pName;
                document.getElementById('report-role').textContent = currentRole.title;
                document.getElementById('report-time').textContent = Math.random().toString(36).substr(2, 9).toUpperCase();
                document.getElementById('report-complaint').textContent = r.chiefComplaint;
                document.getElementById('report-duration').textContent = r.durationAndSeverity;
                document.getElementById('report-summary').textContent = r.summary;
                document.getElementById('report-recommendation').textContent = r.recommendation;
                const sBox = document.getElementById('report-symptoms'); sBox.innerHTML = '';
                (r.reportedSymptoms || []).forEach(s => { const p = document.createElement('span'); p.className = "px-6 py-2.5 bg-blue-500/10 text-blue-400 rounded-2xl text-[10px] font-black uppercase tracking-tighter border border-blue-500/20"; p.textContent = s; sBox.appendChild(p); });
                showView('report'); lucide.createIcons();
            } catch (e) { location.reload(); }
        });

        document.getElementById('download-btn').addEventListener('click', () => {
            if (!lastReport) return;
            const content = `MEDICAL CLINICAL REPORT\n=======================\nPatient: ${pName}\nDepartment: ${currentRole.title}\nID: ${document.getElementById('report-time').textContent}\nDate: ${new Date().toLocaleDateString()}\n\nCHIEF COMPLAINT:\n${lastReport.chiefComplaint}\n\nSYMPTOMS:\n${lastReport.reportedSymptoms.join(', ')}\n\nDURATION & SEVERITY:\n${lastReport.durationAndSeverity}\n\nCLINICAL SUMMARY:\n${lastReport.summary}\n\nRECOMMENDED ACTION:\n${lastReport.recommendation}\n\n-- Verified by AI Medical Specialist --`;
            const blob = new Blob([content], { type: 'text/plain' });
            const url = URL.createObjectURL(blob);
            const a = document.createElement('a'); a.href = url; a.download = `Medical_Report_${pName.replace(/\s+/g, '_')}.txt`;
