...
const [view, setView] = useState("diagnostic"); // 'diagnostic', 'dashboard', 'agent', 'pharmacy', 'symptoms'
              ...
              <div className="animate-in fade-in slide-in-from-bottom-6 duration-700 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  {[{label: "Analyses", val: "2,541", c: "text-violet-600", bg: "bg-violet-50"},
                    ...
                    {label: "Generics Saved", val: "$12k", c: "text-emerald-600", bg: "bg-emerald-50"}].map((s, i) => (
